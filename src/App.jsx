...
import BindingPreview from './pages/BindingPreview'
import BindingList from './pages/BindingList'
import PolicyManager from './pages/PolicyManager'
import BindingFlow from './pages/BindingFlow'
...
function BottomNav() {
  return (
    <nav className="bottom-nav">
      ...
      <NavLink to="/bindings" className={({ isActive }) => `bottom-nav-item ${isActive ? 'active' : ''}`}>
        <span className="bottom-nav-icon">🔗</span>Bindings
      </NavLink>
      <NavLink to="/chat" className={({ isActive }) => `bottom-nav-item ${isActive ? 'active' : ''}`}>
        <span className="bottom-nav-icon">💬</span>Chat
      </NavLink>
    </nav>
  )
}
      ...
      <ToastProvider>
        <div className="app">
          ...
          <Routes>
            ...
            <Route path="/bindings" element={isAuthed ? <BindingList /> : <Navigate to="/login" />} />
            <Route path="/binding-preview" element={isAuthed ? <BindingPreview /> : <Navigate to="/login" />} />
            <Route path="/binding-flow" element={isAuthed ? <BindingFlow /> : <Navigate to="/login" />} />
            <Route path="/policy" element={isAuthed ? <PolicyManager /> : <Navigate to="/login" />} />
            <Route path="/chat" element={isAuthed ? <AgentChat /> : <Navigate to="/login" />} />
            <Route path="/chat/:agentId" element={isAuthed ? <AgentChat /> : <Navigate to="/login" />} />
